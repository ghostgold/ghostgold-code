...
public class TempList {
	public AtomicTemp head;
	public TempList tail;
	public int size;
	public TempList(AtomicTemp h, TempList t) {
		head=h; tail=t;
		if(tail == null)
			size = 1;
		else size = tail.size + 1;
	}
	public TempList(AtomicTemp h){
		head = h;
		tail = null;
	}
	...
	public TempList cloneAdd(AtomicTemp t){
	...
	public TempList cloneRemove(AtomicTemp t){
		if(t.num == head.num){
			if(tail != null)
				return tail.clone();
			else 
	...
	public TempList add(AtomicTemp t){
		TempList a = this;
		TempList pre = null;
	...
	public TempList remove(AtomicTemp t){
		TempList a = this;
		TempList pre = null;
		while(a != null && a.head.num < t.num){
			pre = a;
