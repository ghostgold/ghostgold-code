...
public class Oper extends Instr 
{
	//	Temp.TempList dst;   
	//	Temp.TempList src;
	public AtomicTemp dst;
	public AtomicTemp left, right;
	...
	public Oper(String a, AtomicTemp d, AtomicTemp l, AtomicTemp r, int c, LabelList j, int op) {
		assem=a; 
		dst = d;
		left = l;
		right = r;
	...
	public Oper(String a, AtomicTemp d, AtomicTemp l, AtomicTemp r, int c,  int op) {
		assem=a; 
		dst = d;
		left = l;
		right = r;
	...
	public void setDst(AtomicTemp d){
		dst = d;
		if(dst == null)dsts = null;
		else dsts = new  TempList(dst);
	}

	public void setSrc(AtomicTemp l ,AtomicTemp r){
		left = l;
		right = r;
		if(left != null){
			if(right == null)srcs= new TempList(left);
