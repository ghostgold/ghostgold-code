...
public class AssemLiveness {
	...
	java.util.Dictionary<Assem.Instr, TempList> liveMap = new java.util.Hashtable();
	public AssemLiveness(AssemFlowGraph flow){
		boolean change = true;
		...
		while(nodes != null){
			...
			if(liveat != null)liveMap.put(flow.instr(nodes.head), liveat);
			nodes = nodes.tail;
		}
	}
	public TempList liveAt(Assem.Instr i){
